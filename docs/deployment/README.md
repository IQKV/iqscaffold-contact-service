...
1. **Database Connection Failures**
    ...
    ```bash
    kubectl logs deployment/iqscaffold-contact-service -n iqkvdev-test-env
    ```
...
2. **Redis Connection Issues**
    ...
    kubectl exec -it deployment/iqscaffold-contact-service -n iqkvdev-test-env -- \
...
3. **Check Configuration**
    ...
    ```bash
    kubectl describe configmap iqscaffold-contact-service-config -n iqkvdev-test-env
    ```

4. **Test Health Endpoints**

    ```bash
    kubectl port-forward deployment/iqscaffold-contact-service 8081:8081 -n iqkvdev-test-env
...
helm rollback iqscaffold-contact-service -n iqkvdev-production-env

# Or uninstall completely
helm uninstall iqscaffold-contact-service -n iqkvdev-production-env
```
