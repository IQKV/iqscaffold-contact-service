...
import com.iqscaffold.contactservice.security.JwtAuthenticationFilter;
...
public class SecurityConfig {
    ...
    http
        ...
        .authorizeHttpRequests(authz -> authz
            ...
            .requestMatchers("/api-docs/**", "/swagger-ui/**", "/swagger-ui.html",
                "/api/v1/contacts/health").permitAll()
  ...
  public JwtDecoder jwtDecoder() {
    var jwtProps = iqScaffoldProperties.crm().security().jwt();
  ...
  private boolean isSymmetricConfigured() {
    var secretKey = iqScaffoldProperties.crm().security().jwt().secretKey();
  ...
  public JwtAuthenticationConverter jwtAuthenticationConverter() {
    ...
    authoritiesConverter.setAuthorityPrefix(""); // No prefix - authorities are used as-is
